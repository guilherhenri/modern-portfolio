...
export const BentoGridItem = ({
  ...
  const handleCopy = () => {
    navigator.clipboard.writeText('guilherhenri12@gmail.com')
  ...
  return (
    <div
      className={cn(
        ...
        overflow-hidden rounded-3xl border border-white/[0.1] shadow-input transition
          ...
          {id === 3 && (
            <div className="absolute -right-3 flex w-fit gap-1 lg:-right-2 lg:gap-5">
              ...
              <div className="flex flex-col gap-3 lg:gap-8">
                ...
                {['Node.js', 'Docker', 'Postgresql'].map((item) => (
                  <span
                    key={item}
                    className="rounded-lg bg-[#10132e] px-3 py-2 text-center text-xs opacity-50 lg:px-3 lg:py-4
                      lg:text-base lg:opacity-100"
